	...
	<div class="container-1">
		<div class="menu-1">
			<ul>
				...
				<a href="FILE MANAGER.php"><li class="active-1">Service</li></a>
				<li><a href="about.php" class="active-1"><h4>About</h4></a></li>
				<li><a href="contact-2.php" class="active-1"><h4>Contact</h4></a></li>
				<li><a href="u-logout.php" class="signup-btn-1"><span>Logout<hr class="signup-btn-1" width="40px"></span></a></li>
			</ul>
		</div>
		...
		<div class="si">
			<ul>
				<li><a href="https://www.facebook.com/profile.php?id=100040392433943" ><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
				<li><a href="https://www.instagram.com/_pro_king_4/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
			</ul>
		</div>
 	</div> 
  </i>
